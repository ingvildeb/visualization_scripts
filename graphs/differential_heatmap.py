...
if specified_parent:
    save_path = (
        out_path
        / f"{out_filename_prefix}_{selection_label}_{specified_parent}_{value_column}_{control_group}_{differential_metric}_{orientation}.{out_format}"
    )
else:
    save_path = (
        out_path / f"{out_filename_prefix}_{selection_label}_{value_column}_{control_group}_{differential_metric}_{orientation}.{out_format}"
    )
...
_ontology, _bundle, id_mapping, _color_mapping, _acronym_mapping, _hierarchy_regions = (
    prepare_hierarchy_info_atlaslevels()
)
